...
public class Product {
	...
	@ApiModelProperty(position = 1,notes = "product name is the name of the product",value = "Himalaya")
	private String productName;
	@ApiModelProperty(position = 2,notes = "stock availability")
	private int quantityonHand;
	@ApiModelProperty(position = 3,notes = "cost of the product",value = "300")
	private int price;
